...
INSERT INTO NHACUNGCAP (MANCC, TENNCC, SDT, DIACHI, TRANGTHAINCC)
VALUES (404, N'Fujitsu', '0901234567', N'Nhật Bản', N'Ngừng cung cấp');
...
UPDATE SANPHAM
SET HINHANH = REPLACE(HINHANH, '.webp', '.png')
WHERE HINHANH LIKE '%.webp'

	
UPDATE SANPHAM
SET HINHANH = REPLACE(HINHANH, '.avif', '.png')
WHERE HINHANH LIKE '%.avif'

UPDATE SanPham
SET TRANGTHAISP = N'Còn hàng'
WHERE TRANGTHAISP = N'C?n hàng'
ALTER TABLE SanPham
ALTER COLUMN TRANGTHAISP NVARCHAR(70)

ALTER TABLE KHUYENMAI
ALTER COLUMN LOAIKM NVARCHAR(50);
